...
class Transformer(nn.Module):
    ...
    def forward(
        ...
        if intermediate_layer is None:
            intermediate_layer = max(self.layers // 2 - 1, 0)
        ...
        for i, r in enumerate(self.resblocks):
            ...
            if return_intermediate_features and i == intermediate_layer:
...
class VisionTransformer(nn.Module):
    ...
    def forward(
        ...
        if return_intermediate_features:
            x, intermediate_features = self.transformer(
                x,
                return_intermediate_features=True,
                intermediate_layer=intermediate_layer,
            )
            intermediate_features = intermediate_features.permute(1, 0, 2)
        else:
